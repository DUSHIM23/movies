  ...
  useEffect(() => {
    const fetchMediaDetail = async () => {
      try {
        ...
        toast.error(`Failed to fetch ${mediaType} details`);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <section className="min-h-screen bg-gray-700">
      <div className="relative h-[70vh] min-h-[500px] overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-gray-800 via-gray-800/70 to-transparent" />
      </div>
          ...
          <div className="mt-6 md:mt-0 flex-grow">
            ...
            <div className="mt-2 flex flex-wrap items-center gap-4 text-sm text-gray-300">
              ...
              {(media.vote_average ?? 0) > 0 && (
                <span className="inline-flex items-center rounded-full bg-movie-primary/20 px-2 py-1 text-sm font-medium text-movie-primary">
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              <Button
                ...
                className={cn(
                  "glass-button",
                  inWatchlist && "bg-movie-primary/30"
                )}
              ...
              >
                <Heart
                  className={cn(
                    "mr-2 h-4 w-4",
                    inWatchlist ? "fill-movie-primary text-movie-primary" : ""
                  )}
                />
